...
public class PlayerButton : Billboard
{
    ...
    void Awake()
    {
        ...
        if (_playerButton != null)
            ...
            Debug.LogWarning("PlayerButton: _playerButton reference is null. Assign it in the inspector.");
    }
    ...
    void LateUpdate()
    {
        ...
        //     _playerButton.transform.position = screenPos + (Vector3)_screenOffset;
        // }
        // // Hide button if not
        // else
        // {
